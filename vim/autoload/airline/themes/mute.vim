" vim-airline companion theme of mute
" (https://github.com/Pychimp/vim-mute)
...
let g:airline#themes#mute#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3, s:file)
...
let g:airline#themes#mute#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3, s:file)
...
let g:airline#themes#mute#palette.visual = airline#themes#generate_color_map(s:V1, s:V2, s:V3, s:file)
let g:airline#themes#mute#palette.visual_modified = {
      \ 'airline_c': [ '#ffffff' , '#450000' , 231     , 52      , ''     ] ,
      \ }

let s:IA = [ '#4e4e4e' , '#002b2b' , 59 , 23 , '' ]
let g:airline#themes#mute#palette.inactive = airline#themes#generate_color_map(s:IA, s:IA, s:IA, s:file)


if get(g:, 'loaded_ctrlp', 0)
  let g:airline#themes#mute#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
...
let g:airline#themes#mute#palette.inactive = airline#themes#generate_color_map(s:D1, s:D1, s:D1, s:D1)
