...
hi Search term=standout guifg=#ffffff guibg=#df6f00 ctermbg=166
...
hi CursorLine term=none gui=none cterm=none guibg=#333333 ctermbg=233
...
hi SyntasticError term=reverse gui=bold,underline cterm=bold,underline guifg=#ffafff ctermfg=219 guibg=#a00030 ctermbg=236
hi SyntasticWarning term=standout gui=bold,underline cterm=bold,underline guifg=#ff00af ctermfg=199 guibg=#a00030 ctermbg=235
hi SyntasticWarningLine guibg=#262626 
hi SyntasticErrorLine guifg=#ff80a0 
hi SyntasticWarningSign ctermfg=yellow guibg=#121212 ctermbg=233 guifg=#ff80a0 
hi SyntasticErrorSign ctermfg=red guibg=#121212 ctermbg=233 guifg=#ff80a0 
" }}}
