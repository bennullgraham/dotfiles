...
hi Normal ctermfg=253 ctermbg=235 guifg=#e3f5ff guibg=#1e222c
...
hi CursorLine ctermfg=NONE ctermbg=236 cterm=NONE guifg=NONE guibg=#2a303b gui=bold
...
hi pythonInclude ctermfg=98 cterm=NONE guifg=#6bdb99 gui=NONE
hi pythonFunction ctermfg=98 cterm=bold guifg=#e3f5ff gui=NONE
hi pythonClass ctermfg=98 cterm=bold guifg=#e3f5ff gui=NONE
